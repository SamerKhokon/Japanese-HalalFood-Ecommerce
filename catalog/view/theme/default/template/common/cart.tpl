<div id="cart" class="btn-group btn-block">
  <button style="font-size:12px;" type="button" data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-inverse btn-block btn-lg dropdown-toggle">
