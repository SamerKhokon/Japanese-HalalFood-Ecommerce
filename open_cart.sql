...
insert  into `oc_user`(`user_id`,`user_group_id`,`username`,`password`,`salt`,`firstname`,`lastname`,`email`,`image`,`code`,`ip`,`status`,`date_added`) values (1,1,'admin','e0ebb871c0cf4c29e17d46a02b3634ab1f94e601','30ZjvurwZ','John','Doe','khokon_85seu@hotmail.com','','','',1,'2016-03-09 16:22:52');
